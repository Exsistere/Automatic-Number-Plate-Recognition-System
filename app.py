...
st.markdown("<h3 style='text-align: center; color: red; font-family: font of choice, fallback font no1, sans-serif;'>Automatic Number Plate Recognition</h3>", unsafe_allow_html=True)
...
DEMO_VIDEO = "/content/drive/MyDrive/ANPR/samples/sampleVideo0.mp4"   
DEMO_PIC = "/content/drive/MyDrive/ANPR/samples/Cars3.png"
...
def main():   
    ...
    try:
      ...
      if choice == "Detect From Video File":
        ...
        # Release the video capture object if it has been assigned
        if vid is not None:
            vid.release()
    print("END ............................................................................")
